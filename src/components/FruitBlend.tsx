...
import { fruitBlendData } from "../data/fruitBlendData"; 

const FruitBlend: React.FC = () => {
  return (
    <div className="p-4">
      <h2 id="staple-munch" className="text-2xl font-title mx-7 mb-6 text-green-800">Fruit Blends.</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 sm:border-r-2 gap-6">
        {fruitBlendData.map((item) => (
          <div
            key={item.id}
